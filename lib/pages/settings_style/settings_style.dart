...
class SettingsStyleController extends State<SettingsStyle> {
  ...
  /// Current theme mode (standard Flutter)
  ThemeMode get currentTheme => ThemeController.of(context).flutterThemeMode;

  /// Current AppThemeMode (includes Earthbound)
  AppThemeMode get currentAppThemeMode => ThemeController.of(context).themeMode;

  /// Whether Earthbound theme is active
  bool get isEarthbound => ThemeController.of(context).isEarthbound;

  /// Switch to AppThemeMode (includes Earthbound)
  void switchAppTheme(AppThemeMode? newTheme) {
    if (newTheme == null) return;
    ThemeController.of(context).setThemeMode(newTheme);
    setState(() {});
  }

  /// Switch to standard ThemeMode (for compatibility)
  void switchTheme(ThemeMode? newTheme) {
    if (newTheme == null) return;
    ThemeController.of(context).setFlutterThemeMode(newTheme);
    setState(() {});
  }
