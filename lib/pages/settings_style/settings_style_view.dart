          ...
          children: [
            Padding(
              ...
              child: SegmentedButton<AppThemeMode>(
                selected: {controller.currentAppThemeMode},
                onSelectionChanged: (selected) =>
                    controller.switchAppTheme(selected.single),
                segments: [
                  ButtonSegment(
                  ...
                  // Earthbound theme options
                  ButtonSegment(
                    value: AppThemeMode.earthboundLight,
                    label: const Text('Earthbound'),
                    icon: const Icon(Icons.egg_outlined),
                  ),
                  ButtonSegment(
                    value: AppThemeMode.earthboundDark,
                    label: const Text('EB Dark'),
